...
export default function HairPage(){return <PageShell><Breadcrumbs items={[{label:"Haarmedizin"}]}/><div className="hair-page-hero"><InteriorHero eyebrow="Haarmedizin bei Melimedics" title={<>Haarausfall verstehen.<br/><em>Gezielt handeln.</em></>} intro="Haarmedizin braucht Ursachenklärung, einen realistischen Blick auf Möglichkeiten und einen persönlichen Plan – von der Beratung bis zu einer möglichen operativen Option."><div className="hero-actions"><Link className="button button-light" href="/termin/">Haarberatung vereinbaren <Arrow/></Link><Link className="button button-ghost-light" href="/behandlungsfinder/">Behandlung finden</Link></div></InteriorHero></div>
