...
const treatmentMedia: Partial<Record<string, MediaSlot>> = {
  ...
  haarausfall: mediaSlots.hairLossExamination,
  "prp-haare": mediaSlots.prpPreparation,
  haartransplantation: mediaSlots.hairTransplantConsultation,
...
const treatmentMediaLabels: Partial<Record<string, string>> = {
  ...
  haarausfall: "Haarausfall ärztlich einordnen",
  "prp-haare": "Vorbereitung einer möglichen PRP-Behandlung",
  haartransplantation: "Haartransplantation sorgfältig planen",
