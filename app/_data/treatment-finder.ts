...
export const finderResultGroups: FinderResult[] = [
  ...
  { id: "weight-consultation", title: "Gewichtsmanagement", eyebrow: "Körper & Gesundheit", description: "Eine ärztliche Beratung zu Ausgangssituation, realistischen Zielen und sinnvollen nächsten Schritten.", href: "/gesundheit/", medicalApprovalStatus: "needs_review" },
  { id: "diagnostics-consultation", title: "Blutuntersuchungen & Diagnostik", eyebrow: "Körper & Gesundheit", description: "Eine ärztliche Beratung dazu, welche diagnostische Einordnung zur individuellen Fragestellung passen kann.", href: "/gesundheit/", medicalApprovalStatus: "needs_review" },
