...
export default function PrpPage(){return <CategoryPage path="/behandlungen/prp/" eyebrow="PRP" title={<>Eigenmaterial.<br/><em>Individuell eingesetzt.</em></>} intro="PRP wird aus dem eigenen Blut aufbereitet. Ob eine Behandlung für Ihr Anliegen geeignet ist, wird im ärztlichen Gespräch geprüft." note="Aufbereitung, Sitzungsplanung, mögliche Wirkung und Risiken gehören in die individuelle ärztliche Aufklärung." groups={[
