...
const routes = ["","/behandlungen/","/behandlungen/gesicht/","/behandlungen/haut-laser/","/behandlungen/prp/",...treatments.map(({href}) => href),"/haare/","/gesundheit/","/kosmetik/","/preise/","/arzt-praxis/","/termin/","/kontakt/"];
