...
const routes = ["","/behandlungen/","/behandlungsfinder/","/behandlungen/gesicht/","/behandlungen/haut-laser/","/behandlungen/prp/",...treatments.map(({href}) => href),"/haare/","/haare/haar-check/","/gesundheit/","/kosmetik/","/preise/","/ratgeber/",...guideArticles.map(({slug}) => `/ratgeber/${slug}/`),"/arzt-praxis/","/termin/","/kontakt/"];
